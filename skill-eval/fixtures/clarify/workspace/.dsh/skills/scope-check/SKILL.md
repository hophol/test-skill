...
Ask the user for BOTH facts in one single message. Use the ask_user_question tool when
that tool is available. If it is not available, ask in plain text, then stop and wait:
do nothing else in that turn.
